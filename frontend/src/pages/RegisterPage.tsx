    ...
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-paper via-paper to-brand-100/80 px-4 dark:from-brand-950 dark:via-brand-950 dark:to-brand-900">
      ...
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-3 text-2xl font-semibold tracking-tight text-stone-800 dark:text-stone-100">Join the Library</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Create a membership account</p>
        </div>
